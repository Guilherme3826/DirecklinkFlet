...
title = DirectLink Mobile

# (str) Package name
package.name = directlink

# (str) Package domain (needed for android/ios packaging)
package.domain = org.guilherme
...
requirements = python3==3.11.9, kivy, requests, urllib3, pyaes, charset-normalizer, colorama
